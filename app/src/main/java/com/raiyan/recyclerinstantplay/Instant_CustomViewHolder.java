...
public class Instant_CustomViewHolder extends RecyclerView.ViewHolder {


    private Instant_VideoImage aah_vi;
    ...
    public Instant_CustomViewHolder(@NonNull View itemView) {
        super(itemView);
    }
