...
public class Instant_CustomVideoView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public Instant_CustomVideoView(Context context) {
        this(context, null, 0);
    }

    public Instant_CustomVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Instant_CustomVideoView(Context context, AttributeSet attrs, int defStyle) {
